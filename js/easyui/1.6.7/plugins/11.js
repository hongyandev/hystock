(function ($) {
    function _1(_2) {
        ...
        _7();
        var _8 = _9();
        $(_2).addClass("searchbox-f").textbox($.extend({}, _4, {
            icons: _5,
            buttonText: (_8 ? _8.text : "")
        }));
        ...
        function _9() {
            if (_3.menu) {
                ...
                _3.menu.children("div.menu-item").each(function () {
                    var _f = $.extend({}, $.parser.parseOptions(this), {
    ...
    $.fn.searchbox = function (_11, _12) {
        ...
        return this.each(function () {
            ...
            if (_14) {
                ...
                $.data(this, "searchbox", {
                    options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _11)
                });
            }
            _1(this);
        });
